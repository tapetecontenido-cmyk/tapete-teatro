        ...
        <div className="relative bg-gradient-brand rounded-3xl p-1 shadow-brand-lg">
          <div className="bg-white rounded-[1.4rem] overflow-hidden aspect-[4/5] flex items-center justify-center">
            <div className="text-center p-8">
              <p className="font-display text-7xl text-azul leading-tight">Pronto nuevas<br />funciones</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[100svh] flex items-center overflow-hidden bg-white">
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-10 left-8 lg:left-16 flex flex-col items-center gap-2 animate-bounce cursor-pointer z-10"
     onClick={() => window.scrollTo({ top: window.innerHeight, behavior: 'smooth' })}>
  <MascaraTeatro />
  <span className="text-xs font-heading font-bold tracking-widest uppercase bg-azul text-white px-3 py-1 rounded-lg whitespace-nowrap">Descubre más</span>
