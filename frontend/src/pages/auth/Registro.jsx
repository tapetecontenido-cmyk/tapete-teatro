...
export default function Registro() {
  ...
  const validar = () => {
    ...
    if (!captchaToken) e.captcha = 'Completa la verificación de seguridad';
    setErrores(e);
      ...
      <div className="w-full max-w-lg">
        <div className="card p-8 sm:p-10">
          <div className="text-center mb-8">
            <img src="/logo-tapete.png" alt="Tapete Teatro" className="h-16 w-auto mx-auto mb-4" />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-5">
              ...
              />
              {errores.captcha && <p className="text-red-500 text-xs mt-1">{errores.captcha}</p>}
            </div>
            ...
            <button type="submit" disabled={cargando || !captchaToken} className="btn-primary w-full py-3.5 text-base">
